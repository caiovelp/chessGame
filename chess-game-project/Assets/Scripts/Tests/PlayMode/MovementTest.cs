...
public class MovementTest
{
    ...
    {
        //Peça branca e Rei Preto
        Game game = GameObject.FindGameObjectWithTag("GameController").GetComponent<Game>();
        GameObject whiteChessPieceInstance = game.Create("whiteQueen", 3, 1);
        GameObject blackKingChessPieceInstance = game.Create("blackKing", 4, 2);
        game.SetPosition(whiteChessPieceInstance);
        game.SetPosition(blackKingChessPieceInstance);

        Chessman chessman = whiteChessPieceInstance.GetComponent<Chessman>();
        ...
        GameObject movePlateInstance = Chessman.Instantiate(chessman.movePlate, new Vector3(x, y, -3.0f), Quaternion.identity);
        MovePlate movePlate = movePlateInstance.GetComponent<MovePlate>();
        movePlate.SetReference(whiteChessPieceInstance);
        movePlate.SetCoordinates(4, 2);
        ...
        Assert.IsNull(game.GetPosition(3, 1));
        Assert.AreSame(game.GetPosition(4, 2), whiteChessPieceInstance);
    }

    [Test]
    public void RedMoveplate_Test()
    {
        //Peça branca e Rei Preto
        Game game = GameObject.FindGameObjectWithTag("GameController").GetComponent<Game>();
        GameObject whiteChessPieceInstance = game.Create("whiteQueen", 3, 1);
